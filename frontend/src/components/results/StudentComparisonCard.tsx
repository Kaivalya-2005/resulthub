...
const StudentComparisonCard = ({ student1, student2 }: StudentComparisonCardProps) => {
  ...
  const renderStudentColumn = (student: Student, otherStudent: Student) => (
    <div className="space-y-4">
      <h3 className="text-xl md:text-2xl font-bold text-gray-800">{student.student_name}</h3>
      <p className="text-sm md:text-base text-gray-600">Seat Number: {student.seat_number}</p>
